...
// Custom Modes enum for better mode management
enum Modes 
{
  kCommandMode,
  kInsertMode,
...
global Modes global_mode = Modes::kCommandMode;
...
#define VISUAL_MODE_BUFFER_MARGIN_COLOR 0x0000ff00

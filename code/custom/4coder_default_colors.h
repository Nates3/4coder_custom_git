...
CUSTOM_ID(colors, defcolor_multi_cursors);
CUSTOM_ID(colors, defcolor_main_multi_cursor);
...
CUSTOM_ID(colors, defcolor_multi_mark);
...
CUSTOM_ID(colors, custom_color_operators);

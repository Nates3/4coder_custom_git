...
vtable->buffer_seek_character_predicate_range = buffer_seek_character_predicate_range;
vtable->load_project_list_file_func = load_project_list_file_func;
vtable->get_project_list = get_project_list;
...
vtable->app_get_view_count = app_get_view_count;
...
vtable->view_get_cursor = view_get_cursor;
vtable->view_get_mark = view_get_mark;
vtable->view_get_multi_mark = view_get_multi_mark;
vtable->view_get_selection_begin = view_get_selection_begin;
vtable->view_get_selection_end = view_get_selection_end;
vtable->view_get_modal_state = view_get_modal_state;
...
vtable->view_set_cursor_no_set_mark_rel_index = view_set_cursor_no_set_mark_rel_index;
vtable->view_set_buffer_scroll = view_set_buffer_scroll;
vtable->view_get_mark_history = view_get_mark_history;
vtable->view_record_mark = view_record_mark;
vtable->view_set_mark = view_set_mark;
vtable->view_set_mark_record = view_set_mark_record;
vtable->view_set_multi_mark = view_set_multi_mark;
vtable->view_get_line_selection_mode = view_get_line_selection_mode;
vtable->view_set_line_selection_mode = view_set_line_selection_mode;
vtable->view_get_multi_cursor_mode = view_get_multi_cursor_mode;
vtable->view_set_multi_cursor_mode = view_set_multi_cursor_mode;
vtable->view_get_multi_cursor_count = view_get_multi_cursor_count;
vtable->view_get_multi_cursor = view_get_multi_cursor;
vtable->view_get_first_or_current_multi_cursor = view_get_first_or_current_multi_cursor;
vtable->view_get_top_most_multi_cursor = view_get_top_most_multi_cursor;
vtable->view_get_bottom_most_multi_cursor = view_get_bottom_most_multi_cursor;
vtable->view_get_most_recent_multi_cursor = view_get_most_recent_multi_cursor;
vtable->view_set_multi_cursor = view_set_multi_cursor;
vtable->view_set_multi_cursor_preferred_x = view_set_multi_cursor_preferred_x;
vtable->view_add_multi_cursor = view_add_multi_cursor;
vtable->view_remove_most_recent_multi_cursor = view_remove_most_recent_multi_cursor;
vtable->view_clear_multi_cursors = view_clear_multi_cursors;
vtable->view_correct_multi_cursors = view_correct_multi_cursors;
vtable->view_get_yanked_entire_line = view_get_yanked_entire_line;
vtable->view_set_yanked_entire_line = view_set_yanked_entire_line;
vtable->view_get_vim_cutting_mode = view_get_vim_cutting_mode;
vtable->view_set_vim_cutting_mode = view_set_vim_cutting_mode;
vtable->view_set_selection_begin = view_set_selection_begin;
vtable->view_set_selection_end = view_set_selection_end;
vtable->view_set_modal_state = view_set_modal_state;
vtable->app_get_global_modal_state = app_get_global_modal_state;
vtable->app_set_global_modal_state = app_set_global_modal_state;
vtable->app_get_is_global_modal = app_get_is_global_modal;
vtable->app_set_is_global_modal = app_set_is_global_modal;
vtable->app_set_maps = app_set_maps;
...
buffer_seek_character_predicate_range = vtable->buffer_seek_character_predicate_range;
load_project_list_file_func = vtable->load_project_list_file_func;
get_project_list = vtable->get_project_list;
...
app_get_view_count = vtable->app_get_view_count;
...
view_get_cursor = vtable->view_get_cursor;
view_get_mark = vtable->view_get_mark;
view_get_multi_mark = vtable->view_get_multi_mark;
view_get_selection_begin = vtable->view_get_selection_begin;
view_get_selection_end = vtable->view_get_selection_end;
view_get_modal_state = vtable->view_get_modal_state;
...
view_set_cursor_no_set_mark_rel_index = vtable->view_set_cursor_no_set_mark_rel_index;
view_set_buffer_scroll = vtable->view_set_buffer_scroll;
view_get_mark_history = vtable->view_get_mark_history;
view_record_mark = vtable->view_record_mark;
view_set_mark = vtable->view_set_mark;
view_set_mark_record = vtable->view_set_mark_record;
view_set_multi_mark = vtable->view_set_multi_mark;
view_get_line_selection_mode = vtable->view_get_line_selection_mode;
view_set_line_selection_mode = vtable->view_set_line_selection_mode;
view_get_multi_cursor_mode = vtable->view_get_multi_cursor_mode;
view_set_multi_cursor_mode = vtable->view_set_multi_cursor_mode;
view_get_multi_cursor_count = vtable->view_get_multi_cursor_count;
view_get_multi_cursor = vtable->view_get_multi_cursor;
view_get_first_or_current_multi_cursor = vtable->view_get_first_or_current_multi_cursor;
view_get_top_most_multi_cursor = vtable->view_get_top_most_multi_cursor;
view_get_bottom_most_multi_cursor = vtable->view_get_bottom_most_multi_cursor;
view_get_most_recent_multi_cursor = vtable->view_get_most_recent_multi_cursor;
view_set_multi_cursor = vtable->view_set_multi_cursor;
view_set_multi_cursor_preferred_x = vtable->view_set_multi_cursor_preferred_x;
view_add_multi_cursor = vtable->view_add_multi_cursor;
view_remove_most_recent_multi_cursor = vtable->view_remove_most_recent_multi_cursor;
view_clear_multi_cursors = vtable->view_clear_multi_cursors;
view_correct_multi_cursors = vtable->view_correct_multi_cursors;
view_get_yanked_entire_line = vtable->view_get_yanked_entire_line;
view_set_yanked_entire_line = vtable->view_set_yanked_entire_line;
view_get_vim_cutting_mode = vtable->view_get_vim_cutting_mode;
view_set_vim_cutting_mode = vtable->view_set_vim_cutting_mode;
view_set_selection_begin = vtable->view_set_selection_begin;
view_set_selection_end = vtable->view_set_selection_end;
view_set_modal_state = vtable->view_set_modal_state;
app_get_global_modal_state = vtable->app_get_global_modal_state;
app_set_global_modal_state = vtable->app_set_global_modal_state;
app_get_is_global_modal = vtable->app_get_is_global_modal;
app_set_is_global_modal = vtable->app_set_is_global_modal;
app_set_maps = vtable->app_set_maps;

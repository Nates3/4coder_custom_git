...
function b32
api_definition_generate_api_includes(Arena *arena, API_Definition *api, 
                                     Generated_Group group, API_Generation_Flag flags,
                                     String_Const_u8 code_directory){
  // NOTE(allen): Arrange output files
  
  String_Const_u8 path_to_self = code_directory;

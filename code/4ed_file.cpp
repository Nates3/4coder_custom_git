...
internal void
file_edit_positions_set_cursor(File_Edit_Position *edit_pos, i64 pos)
{
	edit_pos->cursors[0] = pos;
	edit_pos->last_set_type = EditPos_CursorSet;
}

internal void
file_edit_positions_set_scroll(File_Edit_Position *edit_pos, Buffer_Scroll scroll){
	edit_pos->scroll = scroll;
	edit_pos->last_set_type = EditPos_ScrollSet;
}

internal void
file_edit_positions_push(Editing_File *file, File_Edit_Position edit_pos){
